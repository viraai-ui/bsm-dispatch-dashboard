  ...
  return <DashboardShell active="Dashboard">
    <section className="command-dashboard">
      ...
      <section className="metric-ribbon">
        ...
        <Metric icon="MD" label="Media Submitted" value={submittedMedia} sub={`${mediaPending} pending`} tone="purple" />
      </section>
      ...
      <section className="command-grid">
        ...
        <div className="premium-panel media-panel"><PanelHead title="Video Upload Health" /><div className="media-health premium-health"><div><strong>{mediaUploads}</strong><span>Total uploads</span></div><div><strong>{mediaIds.size}</strong><span>Orders with media</span></div><div><strong>{submittedMedia}</strong><span>Submitted</span></div></div></div>

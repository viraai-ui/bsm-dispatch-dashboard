...
export default function PublicPaymentForm() {
  ...
  async function submit(event: FormEvent) {
    ...
    if (files.length > 10) return setError('Attach no more than 10 payment proofs.')
    setBusy(true)
    try {

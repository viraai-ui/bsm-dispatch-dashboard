...
async function run() {
  ...
  for (const path of ['/', '/orders/so-1001', '/orders/so-1002', '/m/262700001', '/m/qr-262700001', '/packaging-tv', '/qr-serial', '/wooden-packing', '/media-proof', '/vehicle-dispatch', '/machine-lookup', '/sync-monitor', '/settings', '/api/orders', '/api/sync/status']) {
